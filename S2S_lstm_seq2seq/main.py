...
def get_datasets():
    train_data_paths = [
        "data/multi30k/train.de",
        "data/multi30k/train.en"
    ]

    valid_data_paths = [
        "data/multi30k/val.de",
        "data/multi30k/val.en"
        ]

    test_data_paths = [
        "data/multi30k/test2016.de",
        "data/multi30k/test2016.en"
        ]
...
if __name__ == "__main__" : 
    if sys.argv[1] == "train":
        ...
        # below code is not appropriate, load Exactly same train data vocab
