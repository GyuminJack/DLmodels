    ...
    def run(self, train_iter, valid_iter, test_iter):
        ...
        for i in range(self.epoch):
            ...
            if best_valid_loss > valid_loss:
                ...
                torch.save(self.model,'../models/best_namu_saved_{}.pt'.format(i))
...
if __name__ == "__main__":
    ...
    txt_path = "/home/jack/torchstudy/06Jun/BERT/data/corpus/train_bert_corpus.txt"
    ...
    train_data_loader = DataLoader(dataset, collate_fn=lambda batch: dataset.collate_fn(batch), batch_size=50, shuffle=True)
